...
// lazy_pointer* runMAGEMin(	int argc, char ** argv, bulk_info z_b, Databases DB, global_variable gv, lazy_pointer *lPointer);
void runMAGEMin(int argc, char ** argv, bulk_info z_b, Databases DB, global_variable gv, outdataCPP *dataOut);
void fill_Cpp_returnDataStructures(		global_variable 	 gv,
								bulk_info 			 z_b,
								PP_ref 				*PP_ref_db,
								SS_ref 				*SS_ref_db,
								csd_phase_set  		*cp,
								stb_system  		*sp, outdataCPP *dataOut
);
